			...
			context "successfully " do 
				...
				context "#accept" do 
					...
					context "when logged in" do 
						setup do 
							@friend = create(:user)
							@user_friendship = create(:pending_user_friendship, user: users(:alicia), friend: @friend)
							create(:pending_user_friendship, friend: users(:alicia), user: @friend)
							sign_in users(:alicia)
				...
				context "#destroy" do 
					...
					context "when logged in" do 
						setup do 
							@friend = create(:user) 
							@user_friendship = create(:accepted_user_friendship, friend: @friend, user: users(:alicia))
							create(:accepted_user_friendship, friend: users(:alicia), user: @friend)
							sign_in users(:alicia)							
						end
